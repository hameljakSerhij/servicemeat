...
class OffersController extends Controller
{
    ...
    {
        //var_dump($this->findModel($id)->offerPrises);
       // die;
        return $this->render('view', [
            'model' => $this->findModel($id),
            'modelHotels' => Hotels::findAll($this->findModel($id)->offerHotels),
            'modelServices' => Services::findAll($this->findModel($id)->offerServices),
            'modelTransports' => Transports::findAll($this->findModel($id)->offerTransports),
            'modelPrises' => Prises::findAll($this->findModel($id)->offerPrises),
